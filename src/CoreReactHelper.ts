...
export class CoreReactHelper {
  ...
  public static injectDynamicContainerElement(containerType: ReactContainersTypes, key: number, parentElement: HTMLElement): HTMLElement {
    return CoreReactHelper.ensureDynamicPlaceholderContainer(containerType, key, parentElement);
  }

  public static clearDynamicContainerElementContent(containerType: ReactContainersTypes, key: number): void {
    const id: string = CoreReactHelper._placeholderElementIdPrefix + key + containerType.toString();
